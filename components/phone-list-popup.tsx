        ...
        >
          ...
          >
            <div className="mb-4 flex items-start justify-between gap-4">
              <div>
                <p className="text-gold-accent uppercase tracking-[0.25em] text-xs">Join the contact list</p>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <div>
                <label htmlFor="contact-list-name" className="mb-1.5 block text-xs uppercase tracking-[0.2em] text-gold-accent/90">
                  Name
                </label>
                <input
              ...
              <div>
                <label htmlFor="contact-list-phone" className="mb-1.5 block text-xs uppercase tracking-[0.2em] text-gold-accent/90">
                  Phone number
                </label>
                <input
              ...
              <button
                ...
                className="w-full rounded-full btn-metallic-gold px-5 py-3 font-semibold uppercase tracking-wider disabled:opacity-60"
              >
