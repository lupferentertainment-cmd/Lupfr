...
describe("app/globals.css gold theme (canonical tokens)", () => {
  ...
  it("keeps :root (light) main gold in a clean champagne family for headings/buttons", () => {
    ...
    expect(rootBlock).toContain("  --background: oklch(0.996 0.001 95);")
    expect(rootBlock).toContain("  --foreground: oklch(0.125 0.018 265);")
    expect(rootBlock).toContain("  --card: oklch(1 0 0);")
    expect(rootBlock).toContain("  --gold: oklch(0.69 0.14 82);")
    expect(rootBlock).toContain("  --btn-gold: oklch(0.66 0.15 82);")
    expect(rootBlock).toContain("  --gradient-heading-gold: linear-gradient(90deg,")
    expect(rootBlock).toContain("      color-mix(in oklch, var(--gold-shadow) 92%, black) 0%,")
    expect(rootBlock).toContain("      color-mix(in oklch, var(--gold-specular) 78%, var(--gold-bright)) 42%,")
    expect(rootBlock).toContain("  --entertainment-line-end: oklch(0.64 0.15 70);")
