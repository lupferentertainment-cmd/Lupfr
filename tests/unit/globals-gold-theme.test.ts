...
describe("app/globals.css gold theme (canonical tokens)", () => {
  ...
  it("keeps :root (light) main gold in a pristine white luxury family for headings/buttons", () => {
    ...
    expect(rootBlock).toContain("  --gold: oklch(0.58 0.15 80);")
    expect(rootBlock).toContain("  --gold-shadow: oklch(0.36 0.085 74);")
    expect(rootBlock).toContain("  --gold-dark: oklch(0.47 0.12 76);")
    expect(rootBlock).toContain("  --gold-bright: oklch(0.76 0.12 86);")
    expect(rootBlock).toContain("  --gold-specular: oklch(0.93 0.05 94);")
    expect(rootBlock).toContain("  --btn-gold: oklch(0.57 0.15 80);")
    expect(rootBlock).toContain("  --btn-gold-shadow: oklch(0.38 0.1 75);")
    expect(rootBlock).toContain("  --btn-gold-dark: oklch(0.48 0.13 77);")
    expect(rootBlock).toContain("  --btn-gold-bright: oklch(0.74 0.12 86);")
    expect(rootBlock).toContain("  --btn-gold-specular: oklch(0.93 0.05 94);")
