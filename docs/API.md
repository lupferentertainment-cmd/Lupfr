...
**Internal.** Resend client: `lib/resend.ts` (`getResendClient()`). Recipient overridable via `RESEND_TO_EMAIL`; default `entertainment@lupfr.com`. Sender: `LUPFR Entertainment <hello@lupfr.com>` (verified domain in Resend).
