...
- `tests/unit/artists-list.test.ts` – YAML-generated featured artist contract: six-card display order, retired artist removal, and new artist social / featured track links.
